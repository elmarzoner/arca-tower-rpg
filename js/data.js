...
const MONSTERS = {
  ...
  // === ボス ===
  // 最初の仲間1体＋Lv3前後を基準に、回復と防御を使えば安定して越えられる強さ。
  b_guardio: { name: 'もんばんガーディオ', spr: 'b_guardio', boss: true, hp: 120, atk: 23, def: 12, agi: 9, exp: 60, gold: 120,
...
const TOWN_DATA = {
  1: {
    name: 'ねもとの むら',
    npcs: [
      { spr: 'elder', x: 8, y: 4, lines: ['わしは むらおさ じゃ。むねの もんしょうが ともるのは 100ねんぶり……。', 'のぼりては とうに えらばれしもの。10かいごとの まもりてを こえ、てんがいの まを めざす さだめじゃ。', 'まずは 40かいの「あけぼのの もん」を めざせ。', 'いし、みず、すな、よる―― よっつの まもりを こえた ものが たどりつく さいしょの くぎりじゃ。', '100ねんまえの のぼりて セツナは…… そこを こえて、かえって こなんだ。', 'ソラよ。どうか むりだけは するでないぞ。'] },
      { spr: 'woman', x: 5, y: 8, lines: ['ごくまれに、たおした まものが おきあがって なかまに なりたがる ことが あるの。', 'まものと こころが かようのは とても めずらしいこと。であえたら たいせつに してあげてね。', 'ソラを ふくめて 4にんまで。まものだけなら 3びき つれていけるわ。「ほしにく」を つかうと なつきやすく なるらしいわ。'] },
  ...
  11: {
    ...
    npcs: [
      ...
      { spr: 'guard', x: 8, y: 12, lines: ['セツナという のぼりての はなし、ばあちゃんに きいたことが ある。', 'この やどばにも とまって、とちゅうの かいそうに てがきを のこして いったそうだ。', 'ガーディオの しるしを もつものは、つぎの まもりびとにも みとめられる―― そんな いいつたえも ある。'] },
    ],
  },
  21: {
    name: 'やどば ミナモ',
    npcs: [
      ...
      { spr: 'man', x: 8, y: 12, lines: ['ポンプが なおって みずが きれいに なった。ありがとうよ。', 'いしと みず。ふたつの しるしが そろったな。', 'ふるい いいつたえじゃ、すなと よるを こえれば「さいしょの あさ」に たどりつくそうだ。'] },
    ],
  },
  31: {
    name: 'しょうにんのまち バザーラ',
    npcs: [
      { spr: 'merchant', x: 5, y: 8, lines: ['いらっしゃい! ドロンゾが きえて しょうばい はんじょう!', 'あいつも むかしは まっすぐな のぼりてだった らしいがねえ。', 'それでも あいつが つくった やすみばに すくわれた ものも いる。ひとは ひといろじゃ ないのさ。'] },
      { spr: 'gald', x: 12, y: 9, lines: ['おれは ガルド。もと おうきゅうの けいびへいだ。', 'ドロンゾとの たたかい みせてもらった。いい うでだ。', 'おまえ 40かいの あけぼのの門を めざすのか……おもしろい。おれも つれていけ!'], event: 'join_gald' },
      { spr: 'woman', x: 8, y: 12, lines: ['うえは とこよの かいそう。よるが あけないの。', '40かいの ノクターナさまは、みんなの あくむを ひとりで ひきうけているんだって。', 'いし、みず、すな、そして よる。よっつを こえた さきが「あけぼのの もん」よ。', 'そこまで いけば、とうの さいしょの ものがたりに ひとつの こたえが でるはず。'] },
      { spr: 'celest', x: 13, y: 6, event: 'jobchange', lines: null },
    ],
  },
  41: {
    name: 'やどば ヨナカ',
...
const BOSS_EVENTS = {
  10: {
    ...
    after: ['ガーディオ「……ミゴトナリ。シンパイハ イラヌヨウダ。」',
      '「ノボリテヨ。100ネンマエノ ショウジョ イライノ ゴウカクダ。」',
      '「コノ シルシハ、ツギノ マモリビトヘ オマエノ ココロヲ ツタエル。」',
      '「イシ、ミズ、スナ、ヨル。ヨッツヲ コエシ トキ、アケボノノ モンハ ヒラク。」',
  ...
  20: {
    ...
    after: ['アクエラ「……ああ そうか。ポンプが こわれて いたのか。」',
      ...
      '「いしの しるしも みえる。ならば わたしも、みずの いのりを たくそう。」',
      '「よっつの しるしは、40かいの あけぼのへ みちびくはずだ。」',
  ...
  30: {
    ...
    before: ['とうぞくおう ドロンゾ「へっへっへ……みぐるみ おいていきな!」',
      ...
      '「40かいの よるを こえるには、すてたものまで ゆめに でてくる。」',
      '「オレは そこまで いくのが こわかった。それだけさ!」',
    ...
    after: ['ドロンゾ「ま まいった! こうさんだ!」',
      ...
      '「いしと みずの しるしに、オレの すなの しるしを かさねな。」',
      '「ノクターナの ゆめに まけず、あけぼのを みせてくれ。」',
      'ドロンゾは かつての「のぼりての やり」を たくした。',
      '※かいだんが あらわれた!'],
  ...
  40: {
    ...
    before: ['よるの じょおう ノクターナ「……ねむりなさい。」',
      ...
      '「いし、みず、すな。みっつの しるしを つれてきたのね。」',
      '「でも さいごの しるしは、つよさでは えらべない。」',
      '「ゆめの なかなら だれも きずつかない。あなたも とわの ゆめへ……。」'],
    after: ['ノクターナ「……そう。あなたは ゆめより げんじつを えらぶのね。」',
      '「わたしが ひきうけた 100ねんぶんの あくむが…… とけていく……。」',
      '「セツナも おなじ こたえを えらんだわ。ミオの あしたを、ゆめに しないために。」',
      '「あのこは この もんを こえ、もっと うえへ のぼっていった。」',
      '「ありがとう。100ねんぶりに あさが みたい。」',
      'あさひが とこよの かいそうに さしこんだ。',
      'いし、みず、すな、よる。よっつの しるしが ひとつの ひかりに なった。',
      'ねもとの むらから ここまでを おおっていた ながい よるが あけていく。',
      'ノクターナ「これが あなたの さいしょの あさ。ここまでの たびは、もう だれにも けせない。」',
      '「このさきの もんが めざめる そのひまで、いまは かえって おひさまを みせてあげて。」',
      'ノクターナの ゆめが「まほうのよろい」に かたちを かえた。',
      'ソラたちの 40かいまでの ぼうけんは、ひとつの くぎりを むかえた。'],
...
const FLAVOR_EVENTS = {
  ...
  4:  ['こわれた にぐるまに、ふるい にもつが のこっている。', 'くすり、ロープ、ちいさな くつ。むかしの のぼりてを だれかが ここまで みおくったらしい。', 'きばこには『つぎに のぼる ひとへ』と かかれている。'],
  5:  ['たきびの あとに、ふたつの コップが ならんでいる。', 'ひとつは ひとの てに、もう ひとつは ちいさな まものの くちに あう おおきさだ。', 'のぼりては いつも ひとりだった わけではない。'],
  6:  ['かべに、たくさんの なまえが ほられている。', 'その したには おおきな いしの ゆびあとと、ひとことだけ のこっていた。', '『ワレハ トメタ。ソレデモ ノボル ト イッタノダ。』'],
  ...
  17: ['からの みずがめを みみに あてると、とおい なみの おとが きこえる。', 'アクエラは この かいそうを ながれる すべての みずの こえを きいているのかもしれない。'],
  18: ['かべに ぬれた てがたが のこっている。', 'ちいさな てだ。だれかが ここまで みずを はこびに きたのだろうか。'],
  19: ['アクエラへ つづく すいろに、くろい よごれが たまっている。', 'こわれた ポンプが、なんど すくっても よごれを はきだしている。', 'みずの せいれいが くるしんでいる りゆうは、もう すぐ そこにある。'],
  22: ['こわれた てんびんが すなに うもれている。', 'かたほうの さらには きんか。もう かたほうには ふるい くすりびん。'],
  23: ['すなの うえに あしあとが てんてんと つづいている。', 'ふるい あしあとだ。100ねんまえの ものかも しれない。'],
  24: ['しょうたいの ふるい ちょうぼが おちている。', '『ごえい ドロンゾ。ほうしゅうは すくないが、けがにんを ひとりも ださなかった。』', 'とうぞくおうにも、だれかを まもって あるいた ころが あった。'],
  26: ['すなの くぼみに、ちいさな やすみばが つくられている。', 'ぬすまれた しょうひんの そばに、むりょうの みずと くすりが おかれていた。', 'わるものの しるしだけでは、ドロンゾの すべては わからない。'],
  27: ['あかい バツの ついた たからの ちずが ある。', 'うらには『たからは 30かいに なし。ここに のこった なかまこそ たから』と らんぼうな じで かかれている。'],
  28: ['やぶれた あかい マントの きれはしが ある。', 'ドロンゾも むかしは この みちを うえへ のぼっていた。'],
  29: ['とうぞくだんの ふるい はたが、かいだんの そばに たてられている。', '『うえへ いけなくなった やつは ここへ こい。ねどこと めしは ある。』', 'その したに『ただし カネは とる』と つけたされていた。'],
  32: ['だれかの ゆめが こおった けっしょうが ある。', 'ふれると なつかしい こえが きこえたが、ことばは おもいだせなかった。'],
  33: ['くらやみの なかで こどもの わらいごえが きこえた きがした。', '……きの せいだろうか。'],
  34: ['あたたかい しょくじが ならんだ まま、だれもいない テーブルが ある。', 'ゆげは いつまでも きえず、とおくから たのしそうな はなしごえだけが きこえる。', 'だれかが さめたくない ゆめの つづきだ。'],
  36: ['よるの じょおうへ あてた かんしゃじょうが、なんびゃくまいも つまれている。', '『こわい ゆめを もっていってくれて ありがとう。』', 'ノクターナは みんなを ねむらせる まえ、ながいあいだ あくむだけを ひきうけていた。'],
  37: ['ひらくたびに ちがう けしきが みえる とびらが ある。', 'むらで もんしょうを もたずに くらす ソラが、たのしそうに わらっていた。', 'ソラは しばらく みつめたあと、じぶんの てで とびらを とじた。'],
  38: ['ねむる のぼりての ために ならべられた ベッドが ある。', 'まくらもとには「めざめる ひまで まつ」と かかれていた。'],
  39: ['あさの いろをした ぬのに、ふるい ことばが ぬいつけられている。', '『ノクターナ。あなたの ゆめは やさしかった。』', '『でも わたしは めざめて、ミオの あしたを さがす。――セツナ』', 'その さきから、100ねん とざされていた あさの においがする。'],
...
const JOIN_EVENTS = {
  join_rino: {
    ...
    lines: ['リノ「あなたが うわさの のぼりて さん?」', '「わたしは リノ。いやしの じゅもんが つかえるの。」', '「ひとりで 40かいの門まで いくなんて むちゃよ。 わたしも つれてって!」'],
    joined: 'リノが なかまに くわわった!',
  },
  join_gald: {
    flag: 'join_gald', who: 'gald',
    lines: ['ガルド「おれは ガルド。もと おうきゅうの けいびへいだ。」', '「ドロンゾとの たたかい みせてもらった。 いい うでだ。」', '「おまえ 40かいの あけぼのの門を めざすのか……おもしろい。 おれも つれていけ!」'],
